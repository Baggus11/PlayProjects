...
namespace SudokuModel
{
    public class Sudoku
    {
        ...
        /// <summary>
        /// TODO: Retire the array appending and use the array.ToString ext
        /// </summary>
        /// <returns></returns>
        public override string ToString()
        {
            ...
            try
            {
                sb.AppendLine(Data.ToSudokuString<byte>());
            }
            catch (Exception ex)
            {
    ...
    {
        public static string ToSudokuString<T>(this T[,] array)
        {
            StringBuilder sb = new StringBuilder();
            try
            {
                int row_length = array.GetLength(0);
                int col_length = array.GetLength(1);
                sb.AppendLine($"+{new string('-', col_length * 2)}+");
