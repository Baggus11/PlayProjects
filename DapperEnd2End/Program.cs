...
/// <summary>
/// NOTE: This is a SAMPLE project from: https://gist.github.com/panesofglass/5212462
/// that shows how to use end to end API to db control using Dapper.
/// </summary>
namespace DapperEnd2End
{
    class Program
    {
